...
},{}],"node_modules/pre-image/index.js":[function(require,module,exports) {
"use strict";
...
},{"./preImage.dev.js":"node_modules/pre-image/preImage.dev.js"}],"mockup/Miku Expo.jpg":[function(require,module,exports) {
module.exports = "/Miku Expo.c25c2c51.jpg";
},{}],"mockup/Ghost Rule.jpg":[function(require,module,exports) {
module.exports = "/Ghost Rule.69e58c79.jpg";
},{}],"mockup/Tower Light Firework.jpg":[function(require,module,exports) {
module.exports = "/Tower Light Firework.7b11772c.jpg";
},{}],"mockup/Rem but it's cool.ori.jpg":[function(require,module,exports) {
module.exports = "/Rem but it's cool.ori.bb4e4aff.jpg";
},{}],"mockup/Yae Sakura illustration.jpg":[function(require,module,exports) {
module.exports = "/Yae Sakura illustration.f85291e8.jpg";
},{}],"mockup/Japanese Scarlet Sister.jpg":[function(require,module,exports) {
module.exports = "/Japanese Scarlet Sister.a2df3071.jpg";
},{}],"index.js":[function(require,module,exports) {
"use strict";

var _litElement = require("lit-element");

var _preImage = _interopRequireDefault(require("pre-image"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class MockupSlider extends _litElement.LitElement {
  constructor() {
    super();
    if (window.localStorage.getItem("preImage") === null) window.localStorage.setItem("preImage", "1");
    if (window.localStorage.getItem("slide") === null) window.localStorage.setItem("slide", "0");
    this.slide = parseInt(window.localStorage.getItem("slide"), 10);
    this.enablePreImage = window.localStorage.getItem("preImage");
    this.image = [require("./mockup/Miku Expo.jpg"), require("./mockup/Ghost Rule.jpg"), require("./mockup//Tower Light Firework.jpg"), require(".//mockup/Rem but it's cool.ori.jpg"), require("./mockup/Yae Sakura illustration.jpg"), require("./mockup/Japanese Scarlet Sister.jpg")];
    if (window.localStorage.getItem("preImage") === "1") window.onload = () => {
      (0, _preImage.default)(require("./mockup/Miku Expo.jpg"), require("./mockup/Ghost Rule.jpg"), require("./mockup//Tower Light Firework.jpg"), require(".//mockup/Rem but it's cool.ori.jpg"), require("./mockup/Yae Sakura illustration.jpg"), require("./mockup/Japanese Scarlet Sister.jpg"));
    };
  }
  ...
  render() {
    return _litElement.html`
			...
			<button id="content" @click="${() => this.togglePreImage()}">
				...
				${window.localStorage.getItem("preImage") === "1" ? "With PreImage" : "Without PreImage"}
			</button>
		`;
  }
...
},{"lit-element":"node_modules/lit-element/lit-element.js","pre-image":"node_modules/pre-image/index.js","./mockup/Miku Expo.jpg":"mockup/Miku Expo.jpg","./mockup/Ghost Rule.jpg":"mockup/Ghost Rule.jpg","./mockup//Tower Light Firework.jpg":"mockup/Tower Light Firework.jpg",".//mockup/Rem but it's cool.ori.jpg":"mockup/Rem but it's cool.ori.jpg","./mockup/Yae Sakura illustration.jpg":"mockup/Yae Sakura illustration.jpg","./mockup/Japanese Scarlet Sister.jpg":"mockup/Japanese Scarlet Sister.jpg"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/pre-image-example.e31bb0bc.js.map